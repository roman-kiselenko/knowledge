...
However, this option has an impact on load balancing, please refer to Load Balancing in [[l2-bgp]]

After the commercial version is installed, the function of obtaining client source IP is enabled by default. 
